...
class BaseModule(ABC):
    ...
    def __init__(self):
        ...
        self.config_manager = None  # Будет установлен позже
    ...
    def is_modern_version(self) -> bool:
        ...
        return '1.8.1' in version or 'modern' in version.lower() or 'binary' in version.lower()
    ...
    def analyze_game_structure(self) -> Dict[str, Any]:
        ...
        if not gamedata_path:
            self._structure_cache = {"status": "no_files", "game_version": self.get_game_version()}
            return self._structure_cache
